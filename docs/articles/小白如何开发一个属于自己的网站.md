...
大家好，我是`元宝`，又是一期干货来啦！由于工作学习的繁忙，真的真的抽不出太多时间，但是我给自己定一个目标，先一周坚持写一篇。话不多说,上期讲解了`域名`是什么以及如何使用，这期咱们就来讲解与它捆绑一起使用的`服务器`，以下内容均为**原创**，如有疑惑、讲的不好亦或是建议等，都可以私信联系我哦～～
...
```
![](https://mmbiz.qpic.cn/mmbiz_png/r06f09AAJOaX4aYd43aQ2qSuEc5icIIqxSs0V6gYlRTs0nicHJSzDiaZgwrCENnIa9M9IhLpC7z8NxZ4PBZl4LZgg/0?wx_fmt=png)
启动之后的浏览器输入`http://localhost:8080`访问nginx代理服务器
![](https://mmbiz.qpic.cn/mmbiz_png/r06f09AAJOaX4aYd43aQ2qSuEc5icIIqxFiae5IpFXhVqvQibMMxiciajqiapBibdQibIy4k8DojLHZC1681593Z43ibzag/0?wx_fmt=png)
...
你就会发现网站的内容发生了变化
![](https://mmbiz.qpic.cn/mmbiz_png/r06f09AAJOaX4aYd43aQ2qSuEc5icIIqxdPJicWw3Zdhibhib3EstDXYnzrteRBadTiaezPITzNYqWLicf1oMY4m60Ug/0?wx_fmt=png)
```sh
# 如果不生效可以在命令行中重载配置
nginx -s reload
```
