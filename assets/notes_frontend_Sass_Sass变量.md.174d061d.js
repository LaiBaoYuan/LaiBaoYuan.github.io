import{_ as s,c as a,o as n,a as l}from"./app.fb84bbb4.js";const u=JSON.parse('{"title":"Sass 变量","description":"","frontmatter":{"title":"Sass 变量"},"headers":[],"relativePath":"notes/frontend/Sass/Sass变量.md","lastUpdated":1677921063000}'),p={name:"notes/frontend/Sass/Sass变量.md"},o=l(`<h2 id="声明和引用变量" tabindex="-1">声明和引用变量 <a class="header-anchor" href="#声明和引用变量" aria-hidden="true">#</a></h2><div class="language-scss"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre class="shiki dracula has-highlighted-lines"><code><span class="line highlighted"><span style="color:#6272A4;">// 定义变量</span></span>
